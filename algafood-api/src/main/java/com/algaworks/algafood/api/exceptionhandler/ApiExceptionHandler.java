...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private static final String MSG_ERRO_GENERICA_USUARIO_FINAL = "Ocorreu um erro interno invesperado no sistema. Tente novamente e se o "
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		Problem problem = createProblemBuilder(status, problemType, 
	...
	private String getFieldNamesJoined(List<Reference> references) {
	...
	private ResponseEntity<Object> handleIgnoredPropertyException(IgnoredPropertyException ex,
			HttpHeaders headers, HttpStatus status, WebRequest request) {
		ProblemType problemType = ProblemType.MENSAGEM_COM_PROPRIEDADE_INVALIDA;
		
		String detail = String.format("Propriedade de nome %s não pode ser informada, "
				+ "pois ela é uma propriedade ignorada do sistema!", ex.getPropertyName());
	...
	private ResponseEntity<Object> handleUnrecognizedPropertyException(UnrecognizedPropertyException ex,
			HttpHeaders headers, HttpStatus status, WebRequest request) {
		ProblemType problemType = ProblemType.MENSAGEM_COM_PROPRIEDADE_INEXISTENTE;
		
		String detail = String.format("Propriedade de nome %s não pode ser informada, "
				+ "pois ela é inexistente!", ex.getPropertyName());
	...
	private ResponseEntity<Object> handleInvalidFormatException(
		...
		String path = getFieldNamesJoined(ex.getPath());
		
		ProblemType problemType = ProblemType.MENSAGEM_INCOMPREENSIVEL;
		String detail = String.format("A propriedade '%s' recebeu o valor '%s'"
				+ " que é de um tipo invalido. Corrija e informe um valor compatível "
	...
	public ResponseEntity<?> handleMethodArgumentTypeMismatchException(
		...
		String detail = String.format("O parâmetro de URL '%s' recebeu o valor "
				+ "'%s', que é de um tipo inválido. Corrija e informe um valor "
				+ "compatível com o tipo '%s'", ex.getParameter().getParameterName()
				,ex.getValue(),ex.getParameter().getParameterType().getSimpleName());
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(
		...
		Problem body = createProblemBuilder(status, ProblemType.RECURSO_NAO_ENCONTRADO, detail)
				.userMessage(detail)
				.build();
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		List<Problem.Object> problemObjects = getAllProblemObjects(bindingResult);
	...
	private List<Problem.Object> getAllProblemObjects(BindingResult bindingResult){
